Java.perform(function() {
    var checkPermissionScript = function() {
      ...
      var checkWriteSmsPermission = function() {
        var writeSmsPermission = ManifestPermission.WRITE_SMS.value;
        checkPermission(writeSmsPermission);
      };
  
      checkWriteSmsPermission();
    };
