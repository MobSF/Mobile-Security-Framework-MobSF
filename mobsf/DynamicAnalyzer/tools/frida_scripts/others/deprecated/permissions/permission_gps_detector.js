Java.perform(function() {
  var checkPermissionScript = function() {
      ...
      var checkFineLocationPermission = function() {
        var fineLocationPermission = ManifestPermission.ACCESS_FINE_LOCATION.value;
        checkPermission(fineLocationPermission);
      };
