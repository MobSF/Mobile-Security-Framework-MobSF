...
class CyberspectScans(models.Model):
    ...
    SAST_END = models.DateField(null=True)
    SBOM_START = models.DateField(null=True)
    SBOM_END = models.DateField(null=True)
    DEPENDENCY_START = models.DateField(null=True)
    DEPENDENCY_END = models.DateField(null=True)
    NOTIFICATION_START = models.DateField(null=True)
    NOTIFICATION_END = models.DateField(null=True)
