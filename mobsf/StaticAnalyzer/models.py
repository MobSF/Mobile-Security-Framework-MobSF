...
class CyberspectScans(models.Model):
    ...
    MOBSF_MD5 = models.CharField(max_length=32, default='')
    ...
    DEPENDENCY_START = models.DateField()
    DEPENDENCY_END = models.DateField()
    NOTIFICATION_START = models.DateField()
    NOTIFICATION_END = models.DateField()
    SUCCESS = models.BooleanField()
    FAILURE_SOURCE = models.CharField(max_length=50, default='')
    FAILURE_MESSAGE = models.TextField(default=[])
    FILE_SIZE_PACKAGE = models.IntegerField()
    FILE_SIZE_SOURCE = models.IntegerField()
