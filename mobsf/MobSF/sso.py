...
class sso(object):
    ...
    def parse_jwt(request):
        if not 'x-amzn-oidc-data' in request.headers:
            return
        ...
        try:
            ...
            logger.exception('Error parsing JWT: ' + encoded_jwt)
            return
        ...
        try:
            ...
            logger.exception('Error retrieving AWS public key: ' + kid)
            return
        ...
        try:
            ...
            logger.exception('Error decoding JWT: ' + encoded_jwt)
            return
