...
DVM_PERMISSIONS = {
    "MANIFEST_PERMISSION": {
        ...
        "BIND_ACCESSIBILITY_SERVICE": ["signature", "", "Must be required by an"],
        "BIND_AUTOFILL_SERVICE": ["signature", "", "Must be required by a"],
        ...
        "BIND_CHOOSER_TARGET_SERVICE": ["signature", "", "Must be required by a"],
        "BIND_CONDITION_PROVIDER_SERVICE": ["signature", "", "Must be required by a"],
        "BIND_DREAM_SERVICE": ["signature", "", "Must be required by an"],
        "BIND_INCALL_SERVICE": ["signature", "", "Must be required by a"],
        "BIND_MIDI_DEVICE_SERVICE": ["signature", "", "Must be required by an"],
        "BIND_NFC_SERVICE": ["signature", "", "Must be required by a"],
        "BIND_NOTIFICATION_LISTENER_SERVICE": ["signature", "", "Must be required by an"],
        "BIND_PRINT_SERVICE": ["signature", "", "Must be required by a"],
        "BIND_QUICK_SETTINGS_TILE": ["normal", "", "Allows an application to bind to third party quick settings tiles."],
        "BIND_REMOTEVIEWS": ["normal", "", "Must be required by a"],
        "BIND_SCREENING_SERVICE": ["signature", "", "Must be required by a"],
        "BIND_TELECOM_CONNECTION_SERVICE": ["signature", "", "Must be required by a"],
        ...
        "BIND_TV_INPUT": ["signature", "", "Must be required by a"],
        "BIND_VISUAL_VOICEMAIL_SERVICE": ["signature", "", "Must be required by a link"],
        "BIND_VOICE_INTERACTION": ["signature", "", "Must be required by a"],
        "BIND_VPN_SERVICE": ["signature", "", "Must be required by a"],
        "BIND_VR_LISTENER_SERVICE": ["signature", "", "Must be required by an"],
