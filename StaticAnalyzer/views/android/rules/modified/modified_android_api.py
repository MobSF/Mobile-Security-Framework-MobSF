...
APIS = [
    ...
    }, 
    {
        ...
        'type': RegexAnd.__name__,
        'match': [(r'dalvik\.system\.PathClassLoader|'r'dalvik\.system\.DexFile|dalvik\.system\.DexPathList'),
    ...
    }, 
    {
        ...
        'match': ['telephony.SmsManager', ['sendMultipartTextMessage', 'sendTextMessage', 'vnd.android-dir/mms-sms']],
        'input_case': InputCase.exact
    }, 
    {
        'desc': 'URL Connection to file/http/https/ftp/jar',
        'type': StringAndOr.__name__,
        'match': ['net.URLConnection', ['openConnection', 'connect', 'openStream']],
        'input_case': InputCase.exact
    }, 
    {
    ...
    }, 
    {
        ...
        'type': StringAndOr.__name__,
        'match': ['javax.net.ssl.HttpsURLConnection', ['HttpsURLConnection', 'connect']],
        'input_case': InputCase.exact
    }, 
    {
    ...
    }, 
    {
        ...
        'type': StringAndOr.__name__,
        'match': ['content.ClipboardManager', ['CLIPBOARD_SERVICE', 'ClipboardManager']],
        'input_case': InputCase.exact
    }, 
    {
        'desc': 'Base64 Encode',
    ...
    }, 
    {
        'desc': 'Message Digest',
        'type': StringAndOr.__name__,
        'match': ['java.security.MessageDigest', ['MessageDigestSpi', 'MessageDigest']],
        'input_case': InputCase.exact
    }, 
    {
        'desc': 'GPS Location',
        'type': StringAndOr.__name__,
        'match': ['android.location', ['getLastKnownLocation(', 'requestLocationUpdates(', 'getLatitude(', 'getLongitude(']],
        'input_case': InputCase.exact
    }
]
