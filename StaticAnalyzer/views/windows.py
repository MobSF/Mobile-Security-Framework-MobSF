...
from MobSF.utils import isDirExists
...
def StaticAnalyzer_Windows(request):
    try:
        ...
        if (m) and (TYP in ['appx']):
            ...
            TOOLS_DIR = os.path.join(DIR, 'StaticAnalyzer/tools/windows/')  #TOOLS DIR
            if TYP == 'appx':
                #DB
