...
parser.add_argument("-i", "--identifier", help="IP:PORT or Serial no of Device/VM. (ex: 192.168.1.2:5555)")
parser.add_argument("-t", "--type", help="Specify the type. Supported types are 1. VM or 2.Device. (ex: 1)")
...
try:
    if args.identifier and args.type:
        ...
        adbconnect = raw_input("Enter the IP:PORT or Serial no of the Device/VM (Ex: 192.168.1.2:5555) and press enter: ")
    ...
    ExecuteCMD([adb, "-s",adbconnect ,"shell", "su", "-c", "chmod", "644", "/system/etc/security/cacerts/0025aabb.0"])
